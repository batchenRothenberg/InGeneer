...
def test_formula_strengthener():
    ...
    # m = s.model()
    # r = strengthen(f, m)
    # print("sterengthened f: "+ str(r))
    # wrapped = wrapper(strengthen,f,m)
    # print("time to strengthen f: " + str(timeit.timeit(wrapped, number=1)))
    # wrapped = wrapper(r.print_all_solutions,10)
    # print("time to find first 10 solutions of strengthned f: " + str(timeit.timeit(wrapped, number=1)))
    # wrapped = wrapper(print_all_models, f, 10)
    # print("time to find first 10 solutions of f: " + str(timeit.timeit(wrapped, number=1)))
    # wrapped = wrapper(r.print_all_solutions,100)
    # print("time to find first 100 solutions of strengthned f: " + str(timeit.timeit(wrapped, number=1)))
    # wrapped = wrapper(print_all_models, f, 100)
    # print("time to find first 100 solutions of f: " + str(timeit.timeit(wrapped, number=1)))
    # f = (x > 0)
    # s.pop()
    # s.push()
    # s.add(f)
